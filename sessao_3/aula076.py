...
def existe(estrutura, chave):
    if estrutura.get(chave) is None:
        print(f"em {estrutura} chave '{chave}' nao existe")
    else:
        print(f"em {estrutura} chave '{chave}' existe")
...
print("")
existe(pessoa3, _ENDERECOS)
existe(pessoa3, _SOBRENOME)
...
em {'nome': 'Edivaldo', 'sobrenome': 'Ribeiro', 'profissao': 'Programador', 'idade': 60, 'altura': 1.72} chave 'enderecos' nao existe
em {'nome': 'Edivaldo', 'sobrenome': 'Ribeiro', 'profissao': 'Programador', 'idade': 60, 'altura': 1.72} chave 'sobrenome' existe
"""
